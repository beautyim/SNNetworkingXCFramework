...
- (instancetype)initWithMainTitle:(NSString * _Nullable)mainTitle vipList:(NSArray<SMAPICVipPackage *> * _Nullable)vipList userVipStatus:(SMAPICGetVipList200ResponseDataUserVipStatus * _Nullable)userVipStatus channel:(NSString * _Nullable)channel __attribute__((swift_name("init(mainTitle:vipList:userVipStatus:channel:)"))) __attribute__((objc_designated_initializer));
...
- (SMAPICGetVipList200ResponseData *)doCopyMainTitle:(NSString * _Nullable)mainTitle vipList:(NSArray<SMAPICVipPackage *> * _Nullable)vipList userVipStatus:(SMAPICGetVipList200ResponseDataUserVipStatus * _Nullable)userVipStatus channel:(NSString * _Nullable)channel __attribute__((swift_name("doCopy(mainTitle:vipList:userVipStatus:channel:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithUid:(SMAPICLong * _Nullable)uid isVip:(SMAPICInt * _Nullable)isVip isVipBoolean:(BOOL)isVipBoolean vipType:(SMAPICInt * _Nullable)vipType vipExp:(NSString * _Nullable)vipExp isExpired:(SMAPICBoolean * _Nullable)isExpired remainingDays:(SMAPICInt * _Nullable)remainingDays __attribute__((swift_name("init(uid:isVip:isVipBoolean:vipType:vipExp:isExpired:remainingDays:)"))) __attribute__((objc_designated_initializer));
...
- (SMAPICGetVipList200ResponseDataUserVipStatus *)doCopyUid:(SMAPICLong * _Nullable)uid isVip:(SMAPICInt * _Nullable)isVip isVipBoolean:(BOOL)isVipBoolean vipType:(SMAPICInt * _Nullable)vipType vipExp:(NSString * _Nullable)vipExp isExpired:(SMAPICBoolean * _Nullable)isExpired remainingDays:(SMAPICInt * _Nullable)remainingDays __attribute__((swift_name("doCopy(uid:isVip:isVipBoolean:vipType:vipExp:isExpired:remainingDays:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
@property (readonly) SMAPICBoolean * _Nullable isExpired __attribute__((swift_name("isExpired")));
...
@property (readonly) SMAPICLong * _Nullable uid __attribute__((swift_name("uid")));
...
*/
@property (readonly) SMAPICInt * _Nullable vipType __attribute__((swift_name("vipType")));
@end
...
- (instancetype)initWithUid:(SMAPICInt * _Nullable)uid email:(NSString * _Nullable)email avatar:(NSString * _Nullable)avatar nickname:(NSString * _Nullable)nickname balance:(SMAPICLong * _Nullable)balance isCheckingName:(SMAPICBoolean * _Nullable)isCheckingName isCheckingFace:(SMAPICBoolean * _Nullable)isCheckingFace __attribute__((swift_name("init(uid:email:avatar:nickname:balance:isCheckingName:isCheckingFace:)"))) __attribute__((objc_designated_initializer));
...
- (SMAPICPostLoginHandle200ResponseOneOfDataUserInfo *)doCopyUid:(SMAPICInt * _Nullable)uid email:(NSString * _Nullable)email avatar:(NSString * _Nullable)avatar nickname:(NSString * _Nullable)nickname balance:(SMAPICLong * _Nullable)balance isCheckingName:(SMAPICBoolean * _Nullable)isCheckingName isCheckingFace:(SMAPICBoolean * _Nullable)isCheckingFace __attribute__((swift_name("doCopy(uid:email:avatar:nickname:balance:isCheckingName:isCheckingFace:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
@property (readonly) SMAPICBoolean * _Nullable isCheckingFace __attribute__((swift_name("isCheckingFace")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="checking_name")
*/
@property (readonly) SMAPICBoolean * _Nullable isCheckingName __attribute__((swift_name("isCheckingName")));
...
- (instancetype)initWithUid:(SMAPICInt * _Nullable)uid email:(NSString * _Nullable)email avatar:(NSString * _Nullable)avatar nickname:(NSString * _Nullable)nickname balance:(SMAPICLong * _Nullable)balance __attribute__((swift_name("init(uid:email:avatar:nickname:balance:)"))) __attribute__((objc_designated_initializer));
...
- (SMAPICPostLoginRegister200ResponseOneOfDataUserInfo *)doCopyUid:(SMAPICInt * _Nullable)uid email:(NSString * _Nullable)email avatar:(NSString * _Nullable)avatar nickname:(NSString * _Nullable)nickname balance:(SMAPICLong * _Nullable)balance __attribute__((swift_name("doCopy(uid:email:avatar:nickname:balance:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithId:(int32_t)id sku:(NSString *)sku days:(int32_t)days price:(NSString *)price title:(NSString * _Nullable)title period:(SMAPICVipPackagePeriod * _Nullable)period productType:(SMAPICInt * _Nullable)productType currency:(NSString * _Nullable)currency subtitle:(NSString * _Nullable)subtitle creditsDescription:(NSString * _Nullable)creditsDescription generateDescription:(NSString * _Nullable)generateDescription isPopular:(SMAPICBoolean * _Nullable)isPopular coinsReward:(SMAPICVipPackageCoinsReward * _Nullable)coinsReward originalPrice:(NSString * _Nullable)originalPrice privilegeList:(NSArray<NSString *> * _Nullable)privilegeList weeklyPrice:(NSString * _Nullable)weeklyPrice coinsPerWeek:(SMAPICInt * _Nullable)coinsPerWeek totalWeeks:(SMAPICInt * _Nullable)totalWeeks isYearly:(SMAPICBoolean * _Nullable)isYearly save:(NSString * _Nullable)save discountPercentage:(SMAPICInt * _Nullable)discountPercentage __attribute__((swift_name("init(id:sku:days:price:title:period:productType:currency:subtitle:creditsDescription:generateDescription:isPopular:coinsReward:originalPrice:privilegeList:weeklyPrice:coinsPerWeek:totalWeeks:isYearly:save:discountPercentage:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SMAPICVipPackageCompanion *companion __attribute__((swift_name("companion")));
- (SMAPICVipPackage *)doCopyId:(int32_t)id sku:(NSString *)sku days:(int32_t)days price:(NSString *)price title:(NSString * _Nullable)title period:(SMAPICVipPackagePeriod * _Nullable)period productType:(SMAPICInt * _Nullable)productType currency:(NSString * _Nullable)currency subtitle:(NSString * _Nullable)subtitle creditsDescription:(NSString * _Nullable)creditsDescription generateDescription:(NSString * _Nullable)generateDescription isPopular:(SMAPICBoolean * _Nullable)isPopular coinsReward:(SMAPICVipPackageCoinsReward * _Nullable)coinsReward originalPrice:(NSString * _Nullable)originalPrice privilegeList:(NSArray<NSString *> * _Nullable)privilegeList weeklyPrice:(NSString * _Nullable)weeklyPrice coinsPerWeek:(SMAPICInt * _Nullable)coinsPerWeek totalWeeks:(SMAPICInt * _Nullable)totalWeeks isYearly:(SMAPICBoolean * _Nullable)isYearly save:(NSString * _Nullable)save discountPercentage:(SMAPICInt * _Nullable)discountPercentage __attribute__((swift_name("doCopy(id:sku:days:price:title:period:productType:currency:subtitle:creditsDescription:generateDescription:isPopular:coinsReward:originalPrice:privilegeList:weeklyPrice:coinsPerWeek:totalWeeks:isYearly:save:discountPercentage:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
@property (readonly) SMAPICInt * _Nullable coinsPerWeek __attribute__((swift_name("coinsPerWeek")));
...
*/
@property (readonly) SMAPICBoolean * _Nullable isYearly __attribute__((swift_name("isYearly")));
...
*/
@property (readonly) SMAPICVipPackagePeriod * _Nullable period __attribute__((swift_name("period")));
