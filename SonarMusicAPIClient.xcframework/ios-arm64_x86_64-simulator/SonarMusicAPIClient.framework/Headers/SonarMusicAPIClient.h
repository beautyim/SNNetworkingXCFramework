...
- (void)initializeGetAccessToken:(NSString * _Nullable (^)(void))getAccessToken getUserAgent:(NSString *(^)(void))getUserAgent isDebug:(BOOL)isDebug __attribute__((swift_name("initialize(getAccessToken:getUserAgent:isDebug:)")));
 ...
 *   kotlinx.serialization.SerialName(value="type")
 *   kotlinx.serialization.Required
 *   kotlinx.serialization.Serializable(with=NormalClass(value=io/sakurasou/ios/bxh/sonar/apiclient/client/models/PostReportSubmitRequestTypeSerializer))
*/
